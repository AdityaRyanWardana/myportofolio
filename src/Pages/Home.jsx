        ...
        <div className="relative z-10 w-full transition-all duration-1000 opacity-100">
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-10">
              ...
              <div className="w-full py-0 md:py-[10%] sm:py-0 lg:w-1/2 h-[260px] sm:h-[350px] lg:h-[480px] xl:h-[600px] relative flex items-center justify-center order-2 lg:order-2 mt-5 sm:mt-0"
