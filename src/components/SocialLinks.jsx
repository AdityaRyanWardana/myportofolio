...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/aditya-ryan-wardana-a0b065348",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@wrddnaa_",
    icon: Instagram,
    url: "https://www.instagram.com/wrddnaa_/?hl=en",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@aditya ryan",
    icon: Youtube,
    url: "https://www.youtube.com/@adityaryan05",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@AdityaRyanWardana",
    icon: Github,
    url: "https://github.com/AdityaRyanWardana",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@adityaryan05",
    color: "black",
